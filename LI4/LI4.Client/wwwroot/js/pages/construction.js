...
window.__BRIDGE_CONSTRUCTION = async function() {
    console.log("======= Construction Script =======");
    ...
    console.log("CONSTRUCTION ELEMENT:", constructionElem, document);
    ...
    try {
        ...
        mc3d = new MC3D({
            ...
            // textureLibraryPath: new URL("../textures", document.location.href),
        ...
        if (controls) {
            ...
            if (sliderContainer && slider) {
                ...
                mcSlider.setSteps(mc3d.mcrender._totalTicks);
...
window.__BRIDGE_CONSTRUCTION_DISPOSE = async function() {
    if (mc3d) {
        mc3d.dispose();
        mc3d = undefined;
    }
...
console.log("Construction script loaded.");